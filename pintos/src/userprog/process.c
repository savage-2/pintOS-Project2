...
process_execute (const char *file_name) 
{
  ...
  /* split executable file_name and parameter_name */
  char *thread_name = NULL;
  char *parameter = NULL;
  thread_name = strtok_r(file_name, " ", &parameter);
  //printf("%d\n",thread_name);
...
start_process (void *file_name_)
{
  ...
  char *token = NULL;
  char *parameter = NULL;
  token = strtok_r(file_name, " ", &parameter);
  ...
  success = load (token, &if_.eip, &if_.esp, &parameter);
